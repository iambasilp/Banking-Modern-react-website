...
const Footer = () => {
  return (
    ...
    >
      ...
      <div className={`app__footer-copyright flex md:flex-row flex-col justify-between w-full items-center border-t-[1px] pt-6 border-t-[#3F3E45] `}>
        <p className="font-poppins font-normal text-center text-[18px] leading-[27px]  text-dimWhite">Copyright 2021 HooBank. All Rights Reserved by Basil Pulikuth.</p>
