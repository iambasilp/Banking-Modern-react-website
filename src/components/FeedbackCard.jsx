  ...
  return (
    <div className="flex flex-col justify-between  px-10 py-12 rounded-[20px] max-w-[370px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card">
      ...
      <div className="flex flex-row">
          <img src={img} alt={name} className='w-[48px] h-[48x] rounded-full object-contain' />
          <div className="flex flex-col ml-4">
              <h4 className="font-poppins font-normal text-[20px] leading-[32px] text-white">{name}</h4>
              <p  className="font-poppins font-normal text-[16px] leading-[24px] opacity-50 text-white">{title}</p>
          </div>
      </div>
    </div>
  );
